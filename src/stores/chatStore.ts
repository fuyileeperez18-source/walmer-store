...
const botResponses: Record<string, string> = {
  ...
  shipping: 'Realizamos envíos a todo el país. Los tiempos de entrega varían entre 2-5 días hábiles según tu ubicación.',
  ...
  contact: 'Puedes contactarnos por WhatsApp al +1234567890 o por email a soporte@walmerstore.com',
